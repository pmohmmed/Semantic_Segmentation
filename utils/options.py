...
def train_opt():
    ...
    ## not required
    parser.add_argument('--pre_path', type=str, default='data/pre.pkl', help="Preprocessor path.")
...
def test_opt():
    ...
    parser.add_argument('--pre_path', type=str, required=True, help="Preprocessor path.")
...
def aug_opt():
    ...
    parser.add_argument('--data_path', type=str, required=True, help="Dataset path.")
    parser.add_argument('--save_path', type=str, required=True, help="Path to save the new data.")
